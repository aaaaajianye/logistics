new Vue({
    ...
    methods:{
        ...
        getAllRepository:function () {
            var _this = this;
            axios.get('/logisticsSystem/repository/selectByPage',{
                params:{
                ...
                .then(function (response) {
                    ...
                    _this.repositoryList = response.data.data.list;
                })
                .catch(function (error) {
                    console.log(error);
                })
        ...
        //获取用户的总页数
        getAllRepositoryCount:function () {
            //在当前方法中定义一个变量，表明是vue对象
            var _this = this;
            axios.get('/logisticsSystem/repository/selectByPage')
                .then(function (response) {
        ...
        setRepositoryId:function (id) {
            //在当前方法中定义一个变量，表明是vue对象
            var _this = this;
            axios.get('/logisticsSystem/ordersEmployeeController/setRepositoryId', {
                params:{
                    repositoryId:id
                }
            })
