new Vue({
    ...
    methods:{
        ...
        getAllOrders:function () {
            var _this = this;
            axios.get('/logisticsSystem/orders/selectPagePaijian',{
                params:{
        ...
        paijianById:function (id) {
            var _this = this;
            axios.get('/logisticsSystem/orders/paijianById', {
                params:{
                    ordersId: id
                }
            })
                .then(function (response) {
                    if (response.data.code == 1) {
                        alert("派件成功！");
                        // 刷新当前页面
                        window.location.href = "employeeOrders2.html";
                    }
                })
                .catch(function (error) {
                    console.log(error);
