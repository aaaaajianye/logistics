new Vue({
    ...
    methods:{
        ...
        // 收件操作
        shoujianById:function (id) {
            var _this = this;
            axios.get('/logisticsSystem/orders/shoujianById', {
                params:{
                    ordersId: id
                }
            })
                .then(function (response) {
                    if (response.data.code == 1) {
                        alert("收件成功！");
                        // 刷新当前页面
                        window.location.href = "employeeOrders.html";
                    }
                })
                .catch(function (error) {
                    console.log(error);
        ...
        getAllOrders:function () {
            var _this = this;
            axios.get('/logisticsSystem/orders/selectPageShoujian',{
                params:{
