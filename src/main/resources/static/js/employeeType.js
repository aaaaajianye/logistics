new Vue({
    ...
    methods:{
        ...
        //获取所有员工岗位的方法
        getAllEmployeeType:function () {
            var _this = this;
            axios.get('/logisticsSystem/employeeType/selectByPage',{
                params:{
                ...
                .then(function (response) {
                    ...
                    _this.employeeTypeList = response.data.data.list;
                })
                .catch(function (error) {
                    console.log(error);
                })
        ...
        //获取用户的总页数
        getAllEmployeeTypeCount:function () {
            //在当前方法中定义一个变量，表明是vue对象
            var _this = this;
            axios.get('/logisticsSystem/employeeType/selectByPage')
                .then(function (response) {
